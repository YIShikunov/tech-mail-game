...
public class GameControllerImplTest {
    ...
    public void mockUpGame() {
        ...
        Assert.assertTrue(session.makeTurn(true, 14, 37));
        Assert.assertEquals(session.state, GameControllerImpl.WaitingFor.SECOND_TURN);
        Assert.assertTrue(session.makeTurn(false, 28, 38));
        Assert.assertTrue(session.makeTurn(true, 12, 42));
        Assert.assertTrue(session.makeTurn(false, 38, 40));
        Assert.assertTrue(session.makeTurn(true, 42, 40));
        Assert.assertEquals(session.state, GameControllerImpl.WaitingFor.SECOND_TURN);
        ...
        Assert.assertTrue(session.makeTurn(false, 21, 28));
        Assert.assertTrue(session.makeTurn(true, 40, 42));
        Assert.assertTrue(session.makeTurn(false, 28, 38));
        Assert.assertTrue(session.makeTurn(true, 42, 12));
        Assert.assertTrue(session.makeTurn(false, 38, 36));
        Assert.assertTrue(session.makeTurn(true, 37, 35));
        Assert.assertTrue(session.makeTurn(false, 2, 21));
        Assert.assertTrue(session.makeTurn(true, 6, 14));
        Assert.assertTrue(session.makeTurn(false, 21, 28));
        Assert.assertTrue(session.makeTurn(true, 13,37));
        Assert.assertTrue(session.makeTurn(false, 28, 38));
        Assert.assertTrue(session.makeTurn(true, 12, 13));
        Assert.assertTrue(session.makeTurn(false, 38, 40));
        Assert.assertTrue(session.makeTurn(true, 13, 6));
        Assert.assertTrue(session.makeTurn(false, 40, 42));
        Assert.assertTrue(session.makeTurn(true, 5, 12));
        Assert.assertTrue(session.makeTurn(false, 18, 2));

        Assert.assertEquals(session.state, GameControllerImpl.WaitingFor.SECOND_ELEMENT_CHOICE);

        Assert.assertFalse(session.makeTurn(true, 42, 11));
